...
namespace exam
{
    public class FinallExam : Exam
    {
        ...
        public FinallExam(int timeOfExam, int numberOfQuestions, MCQQuestion mCQQuestion,TrueOrFalseQuestion trueOrFalseQuestion) :  base(timeOfExam, numberOfQuestions)
        {
        ...
        public void showQuestions(Exam exam)
        {
            ...
            for (int i = 0; i < exam.NumberOfQuestions; i++)
            {
                ...
                foreach (var answer in exam.QuestionsArray[i].Answers)
                {
                    ...
                    if (exam.QuestionsArray[i].Header.Contains("MCQ"))
                    {
